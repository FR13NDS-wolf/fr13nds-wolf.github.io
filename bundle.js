    ...
    (function(t, e) {
        ...
        if (
            ...
            window.addEventListener(
                "click",
                function(t) {
                    for (var o = t.target; o && "A" !== o.tagName; )
                        o = o.parentNode;
                    if (
                        !(
                            !o ||
...
var Util = {
    ...
    request: function(t, e, n, o) {
        ...
        var r = new FormData();
        if ("POST" === t && n)
            for (var c in n) r.append(c, JSON.stringify(n[c]));
        (i.onload = function() {
...
!(function() {
    ...
    var r = document.documentElement,
        ...
        s = document.getElementById("back-to-top"),
    ...
    if (
        ((function() {
            if (
                (s &&
                    ...
                    h > 10
                        ? Util.addClass(s, "fadeInRight")
                        : Util.removeClass(s, "fadeInRight")),
                a)
            ) {
                ...
                (h = c.scrollTop || r.scrollTop),
                    h > 180
                        ? Util.addClass(a, "fixed")
                        : Util.removeClass(a, "fixed");
            }
        })(),
        ...
        Util.bind(window, "scroll", function() {
            ...
            if (s) {
                if (h > 100) {
                    Util.addClass(s, "fadeInRight");
                    Util.removeClass(s, "fadeOutRight");
                    $("#back-to-top")
                        .find(".percentage")
    ...
    l &&
        ...
        "/search/" === location.pathname &&
            Util.request("GET", "https://rhinoc.top/search.json", function(n) {
